...
Aus [Herrenberg][CM-Herrenberg]{:target="_blank"} gibt es, ähnlich dem [Berliner Vorbild][MitradgelegenheitOrg]{:target="_blank"}, schon seit längerem jeden ersten Freitag im Monat eine MitRadGelegenheit zur [Critical Mass Stuttgart][CM-Stuttgart]{:target="_blank"}.  Auch in entgegengesetzte Richtung oder zur [Critical Mass Böblingen][CM-Böblingen]{:target="_blank"} gab es immer wieder Möglichkeiten gemeinsam zu radeln.

Alle diese Fahrten hatten gemeinsam, dass sie nur auf wenigen Seiten publiziert wurden und es selten zeitlich und örtlich feststehende Zustiegsmöglichkeiten gab.  Daher hat sich nun eine kleine Gruppe aus Herrenberg und Stuttgart-Vaihingen zusammengeschlossen, um dies zu ändern.

#### Critical Mass Stuttgart am 06.&nbsp;März 2015
...
An den Zustiegspunkten Böblingen und Vaihingen gibt es auch die Möglichkeit per S-Bahn dazuzustoßen.  Das eignet sich beispielsweise, wenn man aus Renningen kommt oder in Herrenberg noch nicht um 15:30 Uhr losradeln kann.  Angegeben sind jeweils die S-Bahn-Anschlüsse mit Fahrtrichtung Hauptbahnhof.
...
<div class="row">
  ...
  <h4>Bis Stuttgart</h4>
    <div class="panel-group" id="accordionLeft" role="tablist" aria-multiselectable="true">
      ...
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingGärtringen">
          <h4 class="panel-title">
            <a class="collapsed" data-toggle="collapse" data-parent="#accordionLeft" href="#collapseGärtringen"
               aria-expanded="false" aria-controls="collapseGärtringen">
              <strong>Gärtringen</strong>, Bahnhof
              <span class="label label-default" style="float:right;"><span class="fa fa-clock-o"></span> bei Bedarf</span>
            </a>
          </h4>
        </div>
        <div id="collapseGärtringen" class="panel-collapse collapse" role="tabpanel"
             aria-labelledby="headingGärtringen">
          <div class="panel-body">
            <p>Wer möchte, kann sich hier der MitRadGelegenheit
            anschließen.  Damit nicht ewig gewartet werden muss, empfiehlt
            es sich, sich mit der Herrenberger Gruppe in Verbindung zu
      ...
      <div class="panel panel-default">
        ...
        <div id="collapseSchoettle" class="panel-collapse collapse" role="tabpanel"
          ...
          <div class="panel-body">
            ...
            über die Möhringer Straße und die Böblinger Straße zum
      ...
      <div class="panel panel-default">
        ...
        <div id="collapseFeuersee" class="panel-collapse collapse" role="tabpanel"
          ...
          <div class="panel-body">
            ...
            unterhalten.</p>
            <p>Wer hier wartet fühle sich hiermit dazu aufgefordert die
...
<script>
  $(document).ready(function(){
    makeMap(
      "mitradmap",
      "/maps/critical-mass/stuttgart.geojson",
